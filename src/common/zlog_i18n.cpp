...
static const char* gPairs[][2] = {
	...
	{"-r, --bundle_version\tNew CFBundleShortVersionString (marketing version) to change; CFBundleVersion is not modified.\n",
		"-r, --bundle_version\t仅修改 CFBundleShortVersionString（显示版本）；不修改 CFBundleVersion（构建版本）。\n"},
	...
	{"CFBundleShortVersionString: ", "CFBundleShortVersionString（显示版本）："},
